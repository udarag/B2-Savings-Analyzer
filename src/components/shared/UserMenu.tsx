...
export function UserMenu() {
  ...
  return (
    <div className="flex items-center gap-2.5">
      <Link
        href="/analyses/new"
        className="inline-flex items-center gap-1.5 rounded-[9px] bg-c-brand px-[15px] py-2 text-[13px] font-semibold text-white transition-[background-color,box-shadow] duration-200 hover:bg-c-brand-hover hover:shadow-[0_8px_22px_rgba(226,6,38,0.4)]"
      >
